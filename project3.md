...
![port_5000](./images/port_5000.PNG)
...
![welcomeToExpress](./images/WelcomeToExpress.PNG)
...
![toDo js](./images/toDo_js.PNG)

Now we need to update our routes from the file api.js in ‘routes’ directory to make use of the new model.

In Routes directory, open api.js with `vim api.js`, delete the code inside with `:%d` command and paste there code below into it then save and exit

![New Api js](./images/new-api_js.PNG)
...
![mongoDb first image](./images/mongodb_get_started.PNG)

*Allow access to the MongoDB database from anywhere (Not secure, but it is ideal for testing)*
*IMPORTANT NOTE
In the image below, make sure you change the time of deleting the entry from 6 Hours to 1 Week*

![ip_access_list](./images/mongodb_access_list.PNG)

Create a MongoDB database and collection inside mLab

![collection](./images/mongodb_collection.PNG)
...
![Connect](./images/mongodb_connect.PNG)
...
![alt text](./images/new_index_js.PNG)
...
![package json](./images/packageJson_ScriptEdit.PNG)
...
![alt text](./images/Input_js_code.PNG)
...
![list Todo](./images/List_Todo_js.PNG)
